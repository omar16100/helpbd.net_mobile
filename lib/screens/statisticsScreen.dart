import 'package:helpbd.net/chart.dart';
import 'package:helpbd.net/models/summary_model.dart';
import 'package:helpbd.net/services/totalDataServicesDaily.dart';
          ...
          children: <Widget>[
            ...
            Padding(
              padding: EdgeInsets.fromLTRB(
                  UiElements.padding, 0, UiElements.padding, 0),
              child: Row(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      '${summaryData.countries[widget.index].country}',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 20,
                    ...
                    Flags.getMiniFlag(
                        '${summaryData.countries[widget.index].countryCode}',
                        20,
                        20),
                  ]),
            ),
            ...
            Text(
              '${summaryData.countries[widget.index].totalConfirmed}',
              style: TextStyle(
                color: Colors.white,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  SizedBox(width: 20),
                  Text(
                    '${summaryData.countries[widget.index].totalRecovered}',
                    style: TextStyle(
                      color: UiElements.primaryFontColor,
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  SizedBox(width: 20),
                  Text(
                    '${summaryData.countries[widget.index].totalDeaths}',
                    style: TextStyle(
                      color: UiElements.primaryFontColor,
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  SizedBox(width: 20),
                  Text(
                    '${summaryData.countries[widget.index].newConfirmed}',
                    style: TextStyle(
                      color: UiElements.primaryFontColor,
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  SizedBox(width: 20),
                  Text(
                    '${summaryData.countries[widget.index].newDeaths}',
                    style: TextStyle(
                      color: UiElements.primaryFontColor,
                      fontSize: 14,
                      fontWeight: FontWeight.bold,
