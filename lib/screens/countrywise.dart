        ...
        children: <Widget>[
          Padding(
            padding: EdgeInsets.fromLTRB(
                UiElements.padding * 2, 0, UiElements.padding * 1.5, 0),
            child: Row(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  if (selectedSortOption == 'confimed') {
                    ...
                    index = sortedIndexKeysTotalDeaths[
                        (sortedIndexKeysTotalDeaths.length - 1) - index];
                  } else {
                    index = sortedIndexKeysTotalConfirmed[
                        (sortedIndexKeysTotalConfirmed.length - 1) - index];
                  }
                            ...
                            children: <Widget>[
                              Container(
                                ...
                                child: Padding(
                                  padding: EdgeInsets.only(
                                      left: UiElements.padding * 1.5),
                                  child: Text(
                                    summaryData.countries[index].country,
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Text(
                                      '${summaryData.countries[index].totalConfirmed}', //Confirmed cases
                                      style: TextStyle(
                                        color: UiElements.primaryFontColor,
                                        fontSize: 20,
                                        fontWeight: FontWeight.w600,
                              ...
                              Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      Text(
                                        '${summaryData.countries[index].totalDeaths}', // TOD0:update This Data
                                        style: TextStyle(
                                          color: UiElements.primaryFontColor,
                                          fontSize: 20,
                                          fontWeight: FontWeight.w600,
