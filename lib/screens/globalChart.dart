...
class _PieChartGloble extends State {
              ...
              child: Column(
                children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      Text(
                        'Total Deaths: ${summaryData.global.totalDeaths}',
                        style: TextStyle(
                          color: Colors.white,
                          letterSpacing: 1.5,
                          fontWeight: FontWeight.w600,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Text(
                        'Total Recovered: ${summaryData.global.totalRecovered}',
                        style: TextStyle(
                          color: Colors.white,
                          letterSpacing: 1.5,
                          fontWeight: FontWeight.w600,
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Text(
                        'Total Confirmed: ${summaryData.global.totalConfirmed}',
                        style: TextStyle(
                          color: Colors.white,
                          letterSpacing: 1.5,
                          fontWeight: FontWeight.w600,
  ...
  List<PieChartSectionData> showingSections() {
    return List.generate(3, (i) {
      ...
      final double confirmedCasePercent =
          summaryData.global.totalConfirmed.toDouble() /
              (summaryData.global.totalConfirmed.toDouble() +
                  summaryData.global.totalDeaths.toDouble() +
                  summaryData.global.totalRecovered.toDouble()) *
              100;
      final double deathsCasePercent =
          summaryData.global.totalDeaths.toDouble() /
              (summaryData.global.totalConfirmed.toDouble() +
                  summaryData.global.totalDeaths.toDouble() +
                  summaryData.global.totalRecovered.toDouble()) *
              100;
      final double recoveredCasePercent =
          summaryData.global.totalRecovered.toDouble() /
              (summaryData.global.totalConfirmed.toDouble() +
                  summaryData.global.totalDeaths.toDouble() +
                  summaryData.global.totalRecovered.toDouble()) *
